...
public class PropostaCinzas extends javax.swing.JDialog {
    ...
    public PropostaCinzas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public PropostaCinzas(java.awt.Frame parent, boolean modal, List<Amostra> list) {
        super(parent, modal);
        initComponents();
    ...
    private void btnConcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConcluirActionPerformed
        ...
        for(Amostra a : listAmostras){
            ...
            int index = a.getId() - 1;
            a.setCinzas(listAmostraModel.get(index).cinzas);
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        ...
        if(txtCadinhoVazio.isEmpty() || txtAmostra.isEmpty() || txtFinal.isEmpty()){
            ...
            try{
                ...
                am.id = contAmostra + 1;
                am.cinzas = AnaCentCalc.calcCinzas(pCadinho, pAmostra, pFinal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PropostaCinzas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PropostaCinzas dialog = new PropostaCinzas(new javax.swing.JFrame(), true);
