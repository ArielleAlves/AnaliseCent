...
public class PropostaLipidios extends javax.swing.JDialog {
    ...
    public PropostaLipidios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public PropostaLipidios(java.awt.Frame parent, boolean modal, List<Amostra> list) {
        super(parent, modal);
        initComponents();
    ...
    private void btnConcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConcluirActionPerformed
        ...
        for(Amostra a : listAmostras){
            ...
            int index = a.getId() - 1;
            a.setLipidios(listAmostraModel.get(index).lipidios);
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        ...
        if(txtCadinhoVazio.isEmpty() || txtAmostra.isEmpty() || txtFinal.isEmpty()){
            ...
            try{
                ...
                am.id = contAmostra + 1;
                am.lipidios = AnaCentCalc.calcLipidios(pCadinho, pAmostra, pFinal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PropostaLipidios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PropostaLipidios dialog = new PropostaLipidios(new javax.swing.JFrame(), true);
